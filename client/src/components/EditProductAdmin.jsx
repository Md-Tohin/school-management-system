...
const EditProductAdmin = ({ data: propsData, close, fecchPrdouctData }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 right-0 left-0 bg-neutral-800 bg-opacity-70 z-50 p-4 flex justify-center items-center">
      <div className="bg-white p-4 w-full max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[95vh]">
