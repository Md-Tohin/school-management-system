...
const Header = () => { 
  ...
  return (
    <header className="h-24 lg:h-20 lg:shadow-md sticky top-0 z-40 flex flex-col justify-center gap-1 bg-white">
            ...
            <div className="hidden lg:flex items-center gap-10">
              {
                user._id ? (
                  <div className="relative">
                    ...
                    <div className="flex items-center select-none gap-1 cursor-pointer" onClick={() => setOpenUserMenu((preve) => !preve)}>
                      <p>Account</p>
                      {
              ...
              <button onClick={() => setOpenCartSection(true)} className="flex items-center gap-2 bg-green-800 hover:bg-green-700 px-3 py-3 rounded text-white">
                <div className="animate-bounce">
                  <BsCart4 size={26} />
                  <span className="absolute left-3  bottom-5 bg-primary-200 rounded-full px-1 h-6 w-fit text-secondary-200 text-sm">{totalQty}</span>
                </div>
      ...
      <div className="container mx-auto px-2 lg:hidden mb-1">
        <Search />
      </div>
